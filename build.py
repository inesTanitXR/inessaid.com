...
L10N = {
 'fr': dict(dir='ltr', lang='fr',
   ...
   about_paras=[
     ...
     "Mes recherches sont publiées dans l'ACM et l'IEEE (Best Paper Award, IEEE ISEC 2023), et j'ai aussi eu la chance d'être jurée pour Games for Change, EE 30 Under 30 et la Heavener International Case Competition de l'Université de Floride. Tanit XR a aussi parrainé une piste dédiée au patrimoine tunisien au hackathon ImmerseGT de Georgia Tech.",
 ...
 'ar': dict(dir='rtl', lang='ar',
   ...
   about_paras=[
     ...
     'نُشرت أبحاثي لدى ACM وIEEE (جائزة أفضل ورقة بحثية في مؤتمر IEEE ISEC 2023)، وكان لي شرف أن أكون عضوة في لجان التحكيم لدى Games for Change وEE 30 Under 30 وHeavener International Case Competition في جامعة فلوريدا. كما رعت Tanit XR مسارًا خاصًا بالتراث التونسي في هاكاثون ImmerseGT بجامعة Georgia Tech.',
...
<div class="band blush"><div class="wrap" style="text-align:center">
  ...
  <div class="btn-row" style="justify-content:center">
    <a class="btn" href="https://donors.tuesday.app/campaign/CMLPDTO">{L['support_btn']}</a>
